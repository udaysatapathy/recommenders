...
class ContentKNN(AlgoBase):
    def __init__(self, k=40, sim_options = {}, recommenderData):
    ...
    def fit(self, trainset):
        ...
        ml = MovieLens(self.recommenderData.ratingsFilePath, self.recommenderData.moviesFilePath)
        genres = ml.getGenres()
        years = ml.getYears()
